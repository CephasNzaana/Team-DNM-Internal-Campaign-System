...
const supportLevels = [
  { value: '1', label: 'Opposed', description: 'Actively against our candidate' },
  { value: '2', label: 'Leaning Against', description: 'Somewhat opposed to our candidate' },
  { value: '3', label: 'Undecided', description: 'Neutral or undecided' },
  { value: '4', label: 'Leaning Support', description: 'Somewhat supportive of our candidate' },
  { value: '5', label: 'Strong Support', description: 'Strongly supports our candidate' }
];
